...
namespace Learun.Util
{
    ...
    public static class CommonHelper
    {
        ...
        #region 判断是DeBug模式还是Release模式
        /// <summary>
        /// 判断是DeBug模式还是Release模式
        /// </summary>
        /// <returns></returns>
        /// <remarks>
        /// 请先 配置项目 Properties下AssemblyInfo.cs 文件
        /// #if DEBUG
        ...
        public static bool isDeBug
        {
            get
            {
                ...
                foreach (object obj in objArray)
                {
                    ...
                    if (conf != null && !conf.Configuration.IsEmpty())
                    {
                        buildMode = conf.Configuration;
                    }
                }
                return buildMode.ToLower() == "debug";
            }
        }
        #endregion
    }
