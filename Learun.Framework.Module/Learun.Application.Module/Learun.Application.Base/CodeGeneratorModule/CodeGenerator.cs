...
namespace Learun.Application.Base.CodeGeneratorModule
{
    ...
    public class CodeGenerator
    {
        ...
        private string getTransServiceTry(string content, string dbname)
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("        {\r\n");
            sb.Append("            var db = this.BaseRepository().BeginTrans();\r\n");
            sb.Append("            try\r\n");
            sb.Append("            {\r\n");
            sb.Append(content);
            sb.Append("            }\r\n");
        ...
        public string ServiceCreate(CodeBaseConfigModel baseConfigModel)
        {
            try
            {
                ...
                content += "                return this.BaseRepository().FindList<" + baseConfigModel.tableName + "Entity>(strSql.ToString());\r\n";
                ...
                content += "                strSql.Append(fieldSql);\r\n";
                content += "                strSql.Append(\" FROM " + baseConfigModel.tableName + " t \");\r\n";
                content += "                return this.BaseRepository().FindList<" + baseConfigModel.tableName + "Entity>(strSql.ToString(), pagination);\r\n";
                sb.Append(getServiceTry(content));
                // 获取实体数据
                sb.Append("        /// <summary>\r\n");
                sb.Append("        /// 获取实体数据\r\n");
                ...
                content = "";
                content += "                return this.BaseRepository().FindEntity<" + baseConfigModel.tableName + "Entity>(keyValue);\r\n";
                sb.Append(getServiceTry(content));
                sb.Append("        #endregion\r\n\r\n");
                ...
                content = "";
                content += "                this.BaseRepository().Delete<" + baseConfigModel.tableName + "Entity>(t=>t." + pk + " == keyValue);\r\n";
                sb.Append(getServiceTry(content));
                // 新增和更新
                sb.Append("        /// <summary>\r\n");
                ...
                content += "                    this.BaseRepository().Insert(entity);\r\n";
                content += "                }\r\n";
                sb.Append(getServiceTry(content));
        ...
        public string ServiceCreate(string databaseLinkId, List<DbTableModel> dbTableList, Dictionary<string, CodeFormCompontModel> compontMap, QueryModel queryData, ColModel colData, BaseModel baseInfo)
        {
            try
            {
                ...
                if (colData.isPage == "1") // 分页
                {
                    content += "                return this.BaseRepository().FindList<" + mainTable + "Entity>(strSql.ToString(),dp, pagination);\r\n";
                }
                else
                {
                    content += "                return this.BaseRepository().FindList<" + mainTable + "Entity>(strSql.ToString(),dp);\r\n";
                }
                sb.Append(getServiceTry(content));
                ...
                foreach (var tableOne in girdDbTableList)
                {
                    ...
                    content = "";
                    content += "                return this.BaseRepository().FindList<" + tableOne.name + "Entity>(t=>t." + tableOne.field + " == keyValue );\r\n";
                    sb.Append(getServiceTry(content));
                }
                ...
                foreach (var tableOne in dbTableList)
                {
                    ...
                    {
                        content += "                return this.BaseRepository().FindEntity<" + tableOne.name + "Entity>(keyValue);\r\n";
                    }
                    else
                    {
                        content += "                return this.BaseRepository().FindEntity<" + tableOne.name + "Entity>(t=>t." + tableOne.field + " == keyValue);\r\n";
                    }
                    sb.Append(getServiceTry(content));
                }
                ...
                {
                    content += "                this.BaseRepository().Delete<" + mainTable + "Entity>(t=>t." + mainPkey + " == keyValue);\r\n";
                    sb.Append(getServiceTry(content));
                }
                else
                {
        ...
        public string WfServiceCreate(string databaseLinkId, List<DbTableModel> dbTableList, Dictionary<string, CodeFormCompontModel> compontMap, QueryModel queryData, ColModel colData, BaseModel baseInfo, string workField)
        {
            try
            {
                ...
                content = "";
                content += "                return this.BaseRepository().FindEntity<" + mainTable + "Entity>(t=>t." + workField + " == processId);\r\n";
                sb.Append(getServiceTry(content));
        ...
        public string GridEditServiceCreate(string databaseLinkId, string dbTable, string dbTablePk, Dictionary<string, CodeFormCompontModel> compontMap, QueryModel queryData, ColModel colData, BaseModel baseInfo)
        {
            try
            {
                ...
                if (colData.isPage == "1") // 分页
                {
                    content += "                return this.BaseRepository().FindList<" + dbTable + "Entity>(strSql.ToString(),dp, pagination);\r\n";
                }
                else
                {
                    content += "                return this.BaseRepository().FindList<" + dbTable + "Entity>(strSql.ToString(),dp);\r\n";
                }
                sb.Append(getServiceTry(content));
                ...
                content = "";
                content += "                return this.BaseRepository().FindEntity<" + dbTable + "Entity>(keyValue);\r\n";
                sb.Append(getServiceTry(content));
                ...
                sb.Append("        public void DeleteEntity(string keyValue)\r\n");
                content = "";
                content += "                this.BaseRepository().Delete<" + dbTable + "Entity>(t=>t." + dbTablePk + " == keyValue);\r\n";
                sb.Append(getServiceTry(content));
        ...
        public string ReportServiceCreate(string databaseLinkId, string strSql, List<ReportColModel> collist, QueryModel queryData, BaseModel baseInfo)
        {
            try
            {
                ...
                content += "                return this.BaseRepository().FindTable(strSql.ToString(),dp);\r\n";
                sb.Append(getServiceTry(content));
        ...
        public string ControllerCreate(CodeBaseConfigModel baseConfigModel)
        {
            try
            {
                ...
                sb.Append("        /// <returns></returns>\r\n");
                sb.Append("        [HttpGet]\r\n");
                sb.Append("        public ActionResult Detail(string keyValue)\r\n");
                sb.Append("        {\r\n");
                sb.AppendLine("        var mod = " + Str.FirstLower(baseConfigModel.name) + "IBLL.GetEntity(keyValue);");
                sb.Append("             return View(mod);\r\n");
                sb.Append("        }\r\n");
        ...
        public string IndexCreate(CodeBaseConfigModel baseConfigModel)
        {
            try
            {
                ...
                sb.Append("}\r\n");
                sb.Append("<div class=\"lr-layout \" id=\"lr_layout\">\r\n");
                ...
                sb.Append("        <div class=\"lr-layout-wrap\">\r\n");
                sb.Append("            <div class=\"lr-layout-title\">" + baseConfigModel.describe + "</div>\r\n");
                ...
                sb.Append("                        <a id=\"lr_detail\" class=\"btn btn-default\"><i class=\"fa fa-eye\"></i>&nbsp;详情</a>\r\n");
                sb.Append("                    </div>\r\n");
                sb.Append("                </div>\r\n");
                sb.Append("            </div>\r\n");
        ...
        public string IndexJSCreate(CodeBaseConfigModel baseConfigModel)
        {
            try
            {
                ...
                sb.Append("                    width: 1100,\r\n");
                sb.Append("                    height: 800,\r\n");
                ...
                sb.Append("           // 详情\r\n");
                sb.Append("           $('#lr_detail').on('click', function () {\r\n");
                sb.Append("                var keyValue = $('#gridtable').jfGridValue('" + pk + "');\r\n");
                sb.Append("                if (learun.checkrow(keyValue)) {\r\n");
                sb.Append("                    learun.layerIndex({\r\n");
                sb.Append("                        id: 'detail',\r\n");
                sb.Append("                        title: '详情',\r\n");
                sb.Append("                        url: top.$.rootUrl + '/" + baseConfigModel.area + "/" + baseConfigModel.name + "/Detail?keyValue=' + keyValue,\r\n");
                sb.Append("                        width: 1100,\r\n");
                sb.Append("                        height: 800,\r\n");
                sb.Append("                    });\r\n");
                sb.Append("                }\r\n");
        ...
        /// <param name="sb">字串容器</param>
        /// <param name="componts">组件列表</param>
        private void CreateDetailCompont(StringBuilder sb, List<CodeFormCompontModel> componts)
        {
            foreach (var compont in componts)
            {
        ...
        /// <param name="baseConfigModel">基础配置信息</param>
        /// <returns></returns>
        public string DetailCreate(CodeBaseConfigModel baseConfigModel)
        {
            try
            {
                StringBuilder sb = new StringBuilder();
                ...
                sb.Append("@{\r\n");
                sb.Append("    ViewBag.Title = \"" + baseConfigModel.describe + "-详情\";\r\n");
                sb.Append("    Layout = \"~/Views/Shared/_Detail.cshtml\";\r\n");
                sb.Append("}\r\n");
                sb.Append("@model Learun.Application.TwoDevelopment." + baseConfigModel.backArea + "." + baseConfigModel.tableName + "Entity \r\n");
                IEnumerable<DatabaseTableFieldModel> fieldList = databaseTableIBLL.GetTableFiledList(baseConfigModel.databaseLinkId, baseConfigModel.tableName);

                sb.AppendLine("<div class=\"form-button-top\" id=\"wizard-actions\">");
                sb.AppendLine("     <div class=\"btn-group\">");
                sb.AppendLine("         <a id=\"lr-reload\" class=\"btn btn-default\"><i class=\"fa fa-refresh\"></i>&nbsp;刷新</a>");
                sb.AppendLine("         <a id=\"lr-print\" class=\"btn btn-default\"><i class=\"fa fa-print\"></i>&nbsp;打印</a>");
                sb.AppendLine("     </div>");
                sb.AppendLine("</div>");

                sb.AppendLine("<p class=\"print-line\"></p>");

                sb.Append("<div class=\"table-c gridPanel\" id=\"gridPanel\">\r\n");
                sb.AppendLine("     <div class=\"table-c\">");
                sb.AppendLine("          <table border=\"0\" cellspacing=\"0\" cellpadding=\"0\">");
                foreach (var fileditem in fieldList)
                {
                    if ((fieldList.ToList().IndexOf(fileditem) + 2) % 2 == 0)
                    {
                        sb.AppendLine("               <tr>");
                    }
                    sb.AppendLine("                    <th width=\"15%\">" + fileditem.f_remark + "</th>");
                    sb.AppendLine("                    <td width=\"35%\"> @Model." + fileditem.f_column + " </td>");
                    if ((fieldList.ToList().IndexOf(fileditem) + 1) % 2 == 0 || ((fieldList.ToList().IndexOf(fileditem) + 1) >= fieldList.Count()))
                    {
                        sb.AppendLine("               </tr>");
                    }
                }
                sb.AppendLine("          </table>");
                sb.Append("     </div>\r\n</div>\r\n");
                sb.Append("@Html.AppendJsFile(\"/Areas/" + baseConfigModel.area + "/Views/" + baseConfigModel.name + "/Detail.js\")\r\n");
                return sb.ToString();
            }
            catch (Exception)
            {
        ...
        /// <param name="baseConfigModel">基础配置信息</param>
        /// <returns></returns>
        public string DetailCreate(BaseModel baseInfo, List<CodeFormTabModel> formData, Dictionary<string, CodeFormCompontModel> compontMap)
        {
            try
            {
                StringBuilder sb = new StringBuilder();
                ...
                sb.Append("@{\r\n");
                sb.Append("    ViewBag.Title = \"" + baseInfo.describe + "-详情\";\r\n");
                sb.Append("    Layout = \"~/Views/Shared/_Detail.cshtml\";\r\n");
                sb.Append("}\r\n");
                ...
                sb.Append("@Html.AppendJsFile(\"/Areas/" + baseInfo.outputArea + "/Views/" + baseInfo.name + "/Detail.js\")\r\n");
        ...
        /// <param name="baseConfigModel">基础配置信息</param>
        /// <returns></returns>
        public string DetailJsCreate(CodeBaseConfigModel baseConfigModel)
        {
            try
            {
                StringBuilder sb = new StringBuilder();
                ...
                sb.Append("/*");
                sb.Append(" * Copyright (c) 2013-2018 思必达软件技术有限公司\r\n");
                sb.Append(" * 创建人：" + userInfo.realName + "\r\n");
                sb.Append(" * 日  期：" + DateTime.Now.ToString("yyyy-MM-dd HH:mm") + "\r\n");
                sb.Append(" * 描  述：" + baseConfigModel.describe + "\r\n");
                sb.Append(" */\r\n");
                ...
                //插件有BUG，会导致打印页面不完整
                //sb.AppendLine("             //优化滚动条");
                //sb.AppendLine("             $('body').lrscroll();");

                sb.Append("             // 刷新\r\n");
                sb.Append("             $('#lr-reload').on('click', function () {\r\n");
                sb.AppendLine("                 window.location.reload();");
                sb.Append("             });\r\n");

                sb.Append("             // 打印\r\n");
                sb.Append("             $('#lr-print').on('click', function () {\r\n");
                sb.AppendLine("                 $(\"#gridPanel\").jqprint();");
                sb.Append("             });\r\n");
        ...
        /// <param name="compontMap">表单组件信息映射表</param>
        /// <returns></returns>
        public string DetailJsCreate(BaseModel baseInfo, List<DbTableModel> dbTableList, List<CodeFormTabModel> formData, Dictionary<string, CodeFormCompontModel> compontMap)
        {
            try
            {
                StringBuilder sb = new StringBuilder();
                ...
                sb.Append("             // 打印\r\n");
                sb.Append("             $('#lr-print').on('click', function () {\r\n");
                sb.AppendLine("                 $(\"#gridPanel\").printWindow();");
                sb.Append("             });\r\n");
        ...
        /// <param name="codeBaseConfigModel">配置信息</param>
        /// <param name="codeContent">代码内容</param>
        public void CreateDetailCodeFile(CodeBaseConfigModel codeBaseConfigModel, string codeContent)
        {
            try
            {
                CreateCodeFile(codeBaseConfigModel.webDirectory + "\\Areas\\" + codeBaseConfigModel.area + "\\Views\\" + codeBaseConfigModel.name + "\\Detail.cshtml", codeContent, codeBaseConfigModel.webDirectory + "\\Learun.Application.Web.csproj", "Areas\\" + codeBaseConfigModel.area + "\\Views\\" + codeBaseConfigModel.name + "\\Detail.cshtml", true);
            }
            catch (Exception)
            {
                throw;
        ...
        /// <param name="baseInfo">配置信息</param>
        /// <param name="codeContent">代码内容</param>
        public void CreateDetailCodeFile(BaseModel baseInfo, string codeContent)
        {
            try
            {
                CreateCodeFile(baseInfo.webDirectory + "\\Areas\\" + baseInfo.outputArea + "\\Views\\" + baseInfo.name + "\\Detail.cshtml", codeContent, baseInfo.webDirectory + "\\Learun.Application.Web.csproj", "Areas\\" + baseInfo.outputArea + "\\Views\\" + baseInfo.name + "\\Detail.cshtml", true);
            }
            catch (Exception)
            {
                throw;
        ...
        /// <param name="codeBaseConfigModel">配置信息</param>
        /// <param name="codeContent">代码内容</param>
        public void CreateDetailJSCodeFile(CodeBaseConfigModel codeBaseConfigModel, string codeContent)
        {
            try
            {
                CreateCodeFile(codeBaseConfigModel.webDirectory + "\\Areas\\" + codeBaseConfigModel.area + "\\Views\\" + codeBaseConfigModel.name + "\\Detail.js", codeContent, codeBaseConfigModel.webDirectory + "\\Learun.Application.Web.csproj", "Areas\\" + codeBaseConfigModel.area + "\\Views\\" + codeBaseConfigModel.name + "\\Detail.js", true);
            }
            catch (Exception)
            {
                throw;
        ...
        /// <param name="baseInfo">配置信息</param>
        /// <param name="codeContent">代码内容</param>
        public void CreateDetailJSCodeFile(BaseModel baseInfo, string codeContent)
        {
            try
            {
                CreateCodeFile(baseInfo.webDirectory + "\\Areas\\" + baseInfo.outputArea + "\\Views\\" + baseInfo.name + "\\Detail.js", codeContent, baseInfo.webDirectory + "\\Learun.Application.Web.csproj", "Areas\\" + baseInfo.outputArea + "\\Views\\" + baseInfo.name + "\\Detail.js", true);
            }
            catch (Exception)
            {
                throw;
