...
var bootstrap = function ($, learun) {
    ...
    var page = {
        ...
        bind: function () {
            ...
            // 分配角色
            $('#lr_role').on('click', function () {
                var keyValue = $('#gridtable').jfGridValue('F_UserId');
                selectedRow = $('#gridtable').jfGridGet('rowdata');
                if (learun.checkrow(keyValue)) {
                    learun.layerForm({
                        id: 'roleForm',
                        title: '分配角色 - ' + selectedRow.F_RealName,
                        url: top.$.rootUrl + '/LR_OrganizationModule/User/SelectRoleForm?keyValue=' + keyValue,
                        width: 550,
                        height: 590,
                        callBack: function (id) {
                            return top[id].acceptClick();
        ...
        inittree: function () {
            ...
            $('#companyTree').lrtreeSet('setValue', 'c2ff0ab7-80dc-458e-970a-43071a1cc0dc');
        },
        ...
        initGrid: function () {
            $('#gridtable').lrAuthorizeJfGrid({
                ...
                headData: [
                    ...
                    { label: '角色', name: 'RoleName', width: 160, align: 'center' },
                    {
