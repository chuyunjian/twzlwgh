...
namespace Learun.Application.Organization
{
    ...
    public interface DepartmentIBLL
    {
        ...
        /// <returns></returns>
        List<DepartmentEntity> GetList(string companyId, bool filter = true);
        /// <summary>
        /// 获取部门列表信息(根据公司Id)
        /// </summary>
        /// <param name="companyId">公司Id</param>
        ...
        /// <param name="filter">是否过滤权限，默认是</param>
        /// <returns></returns>
        List<TreeModel> GetTree(string companyId, string parentId, bool filter = true);
        /// <summary>
        /// 获取树形数据
        /// </summary>
        /// <param name="companyId">公司id</param>
        /// <param name="parentId">父级id</param>
        /// <returns></returns>
        List<TreeModel> GetTree(List<CompanyEntity> companylist, bool filter = true);
        /// <summary>
        /// 获取部门本身和子部门的id
        /// </summary>
        /// <param name="parentId">父级ID</param>
